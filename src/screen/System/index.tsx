      ...
      <div className="w-full mt-4 flex gap-4">
        ...
        <div className="shadow-main flex-1 rounded-xl flex gap-4 border border-gray-200 p-4">
          ...
          <div className="flex-1 max-w-[16rem] rounded-xl overflow-hidden">
            ...
            {isChoose === "notification" && (
              <img
                src="https://i.pinimg.com/564x/d8/bf/ad/d8bfadc9869cb97c73d7e86c0a9f143c.jpg"
                alt=""
                className="w-full h-full object-cover"
              />
            )}
            {isChoose === "filetray" && (
              <img
                src="https://i.pinimg.com/564x/d9/08/67/d90867c18729111b3aab06e5ca5c14ae.jpg"
                alt=""
                className="w-full h-full object-cover"
              />
            )}
            {isChoose === "general" && (
              <img
                src="https://i.pinimg.com/564x/c6/35/b0/c635b0e10d10ffb042bd54cd8900ad6b.jpg"
                alt=""
                className="w-full h-full object-cover"
              />
            )}
            {isChoose === "background" && (
              <img
                src="https://i.pinimg.com/564x/b8/9b/be/b89bbed6e8ea1dcde27521ff504b1e59.jpg"
                alt=""
                className="w-full h-full object-cover"
              />
            )}
